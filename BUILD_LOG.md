...
### Index — who did what, per entry

| Entry | Candidate (by hand) | Agent (Claude Code) |
|---|---|---|
| **2026-09-12** Scaffold | chose to seed from own Adyen demo as a new repo, chose the Karpathy guidelines | copy, CLAUDE.md, README, first commit |
| **2026-09-12** Auth + first call attempt | reproduced the timeout from own terminal, emailed Cover Genius | signing module from the docs, diagnosis of the TLS timeout |
| **2026-09-13** Decision: build on a fixture while staging is blocked | the decision | proposed it, wrote the fixture from the spec |
| **P1** 2026-09-13 — Strip Adyen | scope + keep-Adyen-optional decision | implementation |
| **P2** 2026-09-13 — Catalog | SKU mix and prices | implementation |
| **P3** 2026-09-13 — Offer proxy, fixture mode | scope, DB / OMS-view decisions | implementation |
| **2026-09-13** Correction: fixture and request rebuilt from the RETAIL schema | asked to confirm the fixture's source (it was wrong) | diff and rebuild |
| **2026-09-13** Finding: idempotency was only on cancel, and P3 had the United Capital bug | the finding | wrote the five rules into CLAUDE.md |
| **2026-09-13** Schema identifier: omit rather than guess | raised the question, chose to omit, emailed CG | recommendation, code change |
| **P4** 2026-09-13 — Checkout page | scope, then four rounds of layout direction | implementation |
| **P4b** 2026-09-13 — Checkout explainability | design (table, split, badge) | implementation |
| **P5** 2026-09-13 — Payload panel | scope per the brief | implementation, found the stale-loading bug |
| **P5b** 2026-09-13 — Equal-height columns | design | CSS |
| **P5c** 2026-09-13 — 60/40 columns | design | CSS |
| **P5d** 2026-09-13 — Offer buttons and badge | design | CSS |
| **P6** 2026-09-13 — Eligibility, consideration #1 | caught that it was never built | implementation |
| **P7** 2026-09-13 — Confirm + ledger, idempotency rules 2–4 | demanded a status check on the rules first | implementation |
| **P8** 2026-09-13 — Cancel path, consideration #4 / rule 5 | asked what #4 meant before accepting the design | implementation |
| **P9** 2026-09-13 — Opt-out on decline | scope | implementation, decline-is-final-at-Continue decision |
| **P10** 2026-09-13 — BOOKING_* webhooks, consideration #6 | scope (routing key, simulator, step-by-step doc) | implementation |
| **P11** 2026-09-13 — Orders view | scope (Map + table, refund home, idempotency visible), required end-to-end testing before submission | implementation |
| **T1** 2026-09-14 — Test Case 1a: eligibility | test, grounding against two doc pages, the 422 question | request-shape fix, A1/A7/A8 |
| **T2** 2026-09-14 — Test Case 1b-i: offer generation | test, spotted the masked-id flicker and the USD-in-Germany | per-currency fixtures, fresh ids |
| **T3** 2026-09-14 — Test Case 1b-ii: decline → opt-out | test, caught the OMS flicker | fix |
| **T4** 2026-09-14 — Test Case 2: accept → pay → confirm | test | — (no change) |
| **T5** 2026-09-14 — Test Case 2b: retry confirm | test, questioned 200 vs 409, asked for the body to be re-checked against the guide | body per the guide, validations, bypass demo |
| **T6** 2026-09-14 — Test Case 2 revisited: confirm silently not called | the catch (a missing log entry) and the guide question | fix |
| **T7** 2026-09-14 — Test Case 2 retest + 2b | retest, spotted the policyholder mismatch | fixture echo |
| **T8** 2026-09-14 — Test Case 3: webhooks | all three cases, correct diagnosis of the duplicate | routed-by in outcomes |
| **T9** 2026-09-14 — Test Case 4: refund | test, caught the USD premium on a GBP order | fix |
| **T10** 2026-09-14 — Test Case 5 + Test Case 4 retest | tests | stage summary |
| **T11** 2026-09-14 — Red team | requested it before submission | findings, five fixes, README next steps |
...
|---|---|
| chose to seed from own Adyen demo as a new repo, chose the Karpathy guidelines | copy, CLAUDE.md, README, first commit |
...
## 2026-09-12 — Auth + first call attempt

| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| reproduced the timeout from own terminal, emailed Cover Genius | signing module from the docs, diagnosis of the TLS timeout |
...
## 2026-09-13 — Decision: build on a fixture while staging is blocked

| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| the decision | proposed it, wrote the fixture from the spec |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| scope + keep-Adyen-optional decision | implementation |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| SKU mix and prices | implementation |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| scope, DB / OMS-view decisions | implementation |
...
## 2026-09-13 — Correction: fixture and request rebuilt from the RETAIL schema

| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| asked to confirm the fixture's source (it was wrong) | diff and rebuild |
...
## 2026-09-13 — Finding: idempotency was only on cancel, and P3 had the United Capital bug

| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| the finding | wrote the five rules into CLAUDE.md |
...
## 2026-09-13 — Schema identifier: omit rather than guess

| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| raised the question, chose to omit, emailed CG | recommendation, code change |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| scope, then four rounds of layout direction | implementation |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| design (table, split, badge) | implementation |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| scope per the brief | implementation, found the stale-loading bug |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| caught that it was never built | implementation |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| demanded a status check on the rules first | implementation |
...
## P8 — 2026-09-13 — Cancel path, consideration #4 / rule 5

| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| asked what #4 meant before accepting the design | implementation |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| scope | implementation, decline-is-final-at-Continue decision |
...
## P10 — 2026-09-13 — BOOKING_* webhooks, consideration #6

| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| scope (routing key, simulator, step-by-step doc) | implementation |
...
## P11 — 2026-09-13 — Orders view

| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| scope (Map + table, refund home, idempotency visible), required end-to-end testing before submission | implementation |
...
## T1 — 2026-09-14 — Test Case 1a: eligibility

| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| test, grounding against two doc pages, the 422 question | request-shape fix, A1/A7/A8 |
...
## T2 — 2026-09-14 — Test Case 1b-i: offer generation

| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| test, spotted the masked-id flicker and the USD-in-Germany | per-currency fixtures, fresh ids |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| test, caught the OMS flicker | fix |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| test, questioned 200 vs 409, asked for the body to be re-checked against the guide | body per the guide, validations, bypass demo |
...
## T6 — 2026-09-14 — Test Case 2 revisited: confirm silently not called

| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| the catch (a missing log entry) and the guide question | fix |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| retest, spotted the policyholder mismatch | fixture echo |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| all three cases, correct diagnosis of the duplicate | routed-by in outcomes |
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| test, caught the USD premium on a GBP order | fix |
...
## T10 — 2026-09-14 — Test Case 5 + Test Case 4 retest
...
| Candidate (by hand) | Agent (Claude Code) |
|---|---|
| requested it before submission | findings, five fixes, README next steps |
